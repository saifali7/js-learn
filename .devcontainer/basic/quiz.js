...
//console.log(null===undefined); // false  ("noll" ek object type hai jo "empty" ya "no value" dikhata hai or "undefined" ek primive value hai jo batata hai value assign nahi hui)
...
console.log([]==false);  true ([] array ko convert karega String me fir Number me convert karega or false ko Number me convert karega to true ayega )
...
/*
console.log(a==undefined); true  (variable a declare hua hai par koi value nahi hai is liye wo undefined hai to a jo undefined hai == undefined true hoga)
console.log(a===undefined); true  (===strict equality check a ki value undefined or type bhi undefined to undefined===undefined true hoga)
*/
...
console.log([]+[]); "" (array ko string me convert karega to "" + "" empty to jawab ayega "")
console.log([1]+[1]); 11  ([1]+[1] ko convert karega string me to "1"+"1" ayega "11")

console.log(false=="0"); true  (false ko convert karega Number me or "0" ko convert karega Number me to ayega true )
console.log(false==="0"); false  (===strict check Boolean or string dono alag alag type hai)
